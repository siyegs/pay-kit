  ...
  return (
    <section className="section-rule py-24 sm:py-32" aria-labelledby="cta-heading">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="premium-shell rounded-lg p-5 sm:p-10 lg:p-12">
          <div className="relative grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
            <div>
              <p className="eyebrow">Ship the first route</p>
              <h2 id="cta-heading" className="text-balance mt-4 max-w-3xl text-3xl font-semibold leading-tight text-foreground sm:text-5xl">
            ...
            <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
              <a
                ...
                className="inline-flex w-full sm:w-auto min-h-12 items-center justify-center gap-2.5 rounded-md bg-foreground px-5 text-sm font-bold text-surface transition hover:bg-brand"
              >
